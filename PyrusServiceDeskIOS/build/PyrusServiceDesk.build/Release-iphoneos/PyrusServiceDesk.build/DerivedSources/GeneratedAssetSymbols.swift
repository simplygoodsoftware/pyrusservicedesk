...
extension ImageResource {
    ...
    static let chats = ImageResource(name: "chats", bundle: resourceBundle)
    ...
    static let fillFilter = ImageResource(name: "fillFilter", bundle: resourceBundle)
    ...
    static let iiko = ImageResource(name: "iiko", bundle: resourceBundle)

    /// The "paperclip" asset catalog image resource.
    static let paperclip = ImageResource(name: "paperclip", bundle: resourceBundle)
