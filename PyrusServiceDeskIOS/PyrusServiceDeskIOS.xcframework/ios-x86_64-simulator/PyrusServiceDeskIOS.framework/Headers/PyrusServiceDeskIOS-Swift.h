...
#ifndef PYRUSSERVICEDESKIOS_SWIFT_H
#define PYRUSSERVICEDESKIOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PyrusServiceDeskIOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP19PyrusServiceDeskIOS11FileChooser_")
...
/// Protocol to send status messages of completion.
SWIFT_PROTOCOL("_TtP19PyrusServiceDeskIOS19FileChooserDelegate_")
@protocol FileChooserDelegate
/// Send succes status
...
SWIFT_PROTOCOL("_TtP19PyrusServiceDeskIOS9LogEvents_")
@protocol LogEvents
...
SWIFT_PROTOCOL("_TtP19PyrusServiceDeskIOS18NewReplySubscriber_")
...
SWIFT_PROTOCOL("_TtP19PyrusServiceDeskIOS14OnStopCallback_")
...
/// The showed
SWIFT_CLASS("_TtC19PyrusServiceDeskIOS11PSDInfoView")
...
SWIFT_CLASS("_TtC19PyrusServiceDeskIOS16PyrusServiceDesk")
...
SWIFT_CLASS("_TtC19PyrusServiceDeskIOS24ServiceDeskConfiguration")
