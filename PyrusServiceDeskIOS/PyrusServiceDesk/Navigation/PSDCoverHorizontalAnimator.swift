...
class CoverHorizontalAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if (_fromView != nil && _toView != nil && viewForSnapshot?.snapshotView(afterScreenUpdates: true) != nil){
            fromView = _fromView!
            toView = _toView!
            var frame = inView.bounds
            let snapshot : UIView =  (viewForSnapshot?.snapshotView(afterScreenUpdates: true))!
