...
//            }
    ...
    func draw(message: PSDRowMessage) {
        ...
        messageTextView.linkTextAttributes = [
            ...
            NSAttributedString.Key.foregroundColor: message.message.isOutgoing && !message.message.isWelcomeMessage ? CustomizationHelper.userMassageTextColor : UIColor.appColor
        ]
