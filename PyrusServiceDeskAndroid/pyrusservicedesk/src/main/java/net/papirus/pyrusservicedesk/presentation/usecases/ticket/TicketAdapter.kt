...
import net.papirus.pyrusservicedesk.presentation.usecases.ticket.entries.Type
import net.papirus.pyrusservicedesk.presentation.view.CommentView
import net.papirus.pyrusservicedesk.presentation.view.ContentType
