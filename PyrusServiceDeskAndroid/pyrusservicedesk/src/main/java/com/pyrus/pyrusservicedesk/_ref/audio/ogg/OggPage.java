 ...
 */
package com.pyrus.pyrusservicedesk._ref.audio.ogg;

import static com.pyrus.pyrusservicedesk._ref.audio.ogg.IOUtils.readOrEOF;
...
public class OggPage {
    ...
    public boolean hasContinuation() {
        ...
        return IOUtils.toInt(lvs[numLVs - 1]) == 255;
    }
    /**
