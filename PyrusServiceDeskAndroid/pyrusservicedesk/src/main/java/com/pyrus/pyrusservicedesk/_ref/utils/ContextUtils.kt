 ...
 */
fun <T : ViewModel> FragmentActivity.getViewModel(viewModelClass: Class<T>): Lazy<T> {
...
fun Fragment.dispatchTakeVideoIntent(requestCode: Int): Uri? {
 ...
 */
fun Fragment.dispatchTakePhotoIntent(requestCode: Int): Uri? {
