...
fun TextView.animateTextColor(toColor: Int, duration: Long = 300) {
...
internal fun View.animateVisibility(isVisible: Boolean, duration: Long = 300, fadeInStartDelay: Long = 0L) {
    if (isVisible) fadeIn(duration, fadeInStartDelay)
    else fadeOut(duration)
}

internal fun View.fadeIn(duration: Long = 300, startDelay: Long) {
    this.alpha = 0f
...
internal fun View.fadeOut(duration: Long = 300) {
    animate()
        .alpha(0f)
        .setDuration(duration)
        .withEndAction {
