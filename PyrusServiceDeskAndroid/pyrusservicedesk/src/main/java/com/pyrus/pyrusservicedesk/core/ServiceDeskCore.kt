...
import com.pyrus.pyrusservicedesk.presentation.ui.navigation_page.tickets_list.ticketsList.TicketsListFeatureFactory
...
//    )
    ...
    private val syncRepository: SyncRepository = SyncRepository(retrofit)

    fun ticketsFeatureFactory(): TicketsFeatureFactory {
        return TicketsFeatureFactory(storeFactory, syncRepository)
    }
