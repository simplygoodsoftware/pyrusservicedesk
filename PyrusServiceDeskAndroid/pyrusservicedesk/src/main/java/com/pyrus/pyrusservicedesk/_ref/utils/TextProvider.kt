...
sealed interface TextProvider: Parcelable {
...
fun Int.textRes(): TextProvider = TextProvider.Res(this)

operator fun TextProvider.plus(textProvider: TextProvider): TextProvider {
    return TextProvider.Combine(this, textProvider)
}

operator fun TextProvider.plus(text: String): TextProvider {
    return TextProvider.Combine(this, text.textRes())
}

fun String.textRes(): TextProvider = TextProvider.Simple(this)

fun TextProvider.text(context: Context): String = when(this) {
