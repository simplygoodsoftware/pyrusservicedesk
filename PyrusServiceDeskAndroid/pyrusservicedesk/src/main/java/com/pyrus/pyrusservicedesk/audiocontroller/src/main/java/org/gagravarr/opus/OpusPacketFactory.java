...
import static com.pyrus.pyrusservicedesk.audiocontroller.src.main.java.org.gagravarr.opus.OpusPacket.MAGIC_HEADER_BYTES;
import static com.pyrus.pyrusservicedesk.audiocontroller.src.main.java.org.gagravarr.opus.OpusPacket.MAGIC_TAGS_BYTES;

import com.pyrus.pyrusservicedesk.audiocontroller.src.main.java.org.gagravarr.ogg.HighLevelOggStreamPacket;
...
public class OpusPacketFactory extends HighLevelOggStreamPacket {
   ...
   protected static boolean isOpusSpecial(OggPacket packet) {
       ...
       return IOUtils.byteRangeMatches(MAGIC_TAGS_BYTES, d, 0);
