...
internal class TicketsListFragment: TeaFragment<State, Message, Effect>()  {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        parentFragmentManager.setFragmentResultListener(KEY_USER_ID, this) { _, bundle ->
            ...
            dispatch(Message.Inner.UserIdSelected(result))
        }

        //TODO add feature
        val feature = getStore { PyrusServiceDesk.injector().ticketsListFeatureFactory(appId).create() }

         bind(BinderLifecycleMode.CREATE_DESTROY) {
             messages bindTo feature
         }
         bind {
             feature.states().debounce(200) bindTo this@TicketsListFragment
