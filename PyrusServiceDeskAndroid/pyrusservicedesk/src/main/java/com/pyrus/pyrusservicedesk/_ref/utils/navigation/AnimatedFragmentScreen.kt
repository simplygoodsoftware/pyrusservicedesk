...
internal interface AnimatedFragmentScreen: FragmentScreen {
 ...
 *                FragmentManager.popBackStack() or similar methods.
 */
internal fun FragmentScreen.setAnimation(enter: Int, exit: Int, popEnter: Int, popExit: Int): AnimatedFragmentScreen {
 ...
 *              view of the fragment being removed or detached.
 */
internal fun FragmentScreen.setAnimation(enter: Int, exit: Int) = setAnimation(enter, exit, 0, 0)

internal fun FragmentScreen.setSlideRightAnimation() = setAnimation(
...
internal fun FragmentScreen.setFadeAnimation() = setAnimation(
