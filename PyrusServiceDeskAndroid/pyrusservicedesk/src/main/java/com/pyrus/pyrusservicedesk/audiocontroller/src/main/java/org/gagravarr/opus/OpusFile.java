...
import com.pyrus.pyrusservicedesk.audiocontroller.src.main.java.org.gagravarr.ogg.OggFile;
import com.pyrus.pyrusservicedesk.audiocontroller.src.main.java.org.gagravarr.ogg.OggPacket;
import com.pyrus.pyrusservicedesk.audiocontroller.src.main.java.org.gagravarr.ogg.OggPacketReader;
import com.pyrus.pyrusservicedesk.audiocontroller.src.main.java.org.gagravarr.ogg.OggPacketWriter;
import com.pyrus.pyrusservicedesk.audiocontroller.src.main.java.org.gagravarr.ogg.OggStreamIdentifier;
import com.pyrus.pyrusservicedesk.audiocontroller.src.main.java.org.gagravarr.ogg.audio.OggAudioHeaders;
import com.pyrus.pyrusservicedesk.audiocontroller.src.main.java.org.gagravarr.ogg.audio.OggAudioSetupHeader;
import com.pyrus.pyrusservicedesk.audiocontroller.src.main.java.org.gagravarr.ogg.audio.OggAudioStream;
...
public class OpusFile implements OggAudioStream, OggAudioHeaders, Closeable {
     ...
     */
    public OpusFile(File f) throws IOException {
    ...
    public void close() throws IOException {
        ...
        if (w != null) {
            ...
            w.bufferPacket(tags.write(), true); // CHANGED: flush=true after writing tags.
            ...
            for (int i = 0; i < packetsSize; i++) {
                ...
                if (doneFlush) {   
                    pageSize = 0;
                    pageSamples = 0;
                    doneFlush = false; // CHANGED: add doneFlush=false
                }
            }

            w.setGranulePosition(lastGranule+pageSamples); // CHANGED: update granule position
            w.close();
            w = null;
            ogg.close();
            ogg = null;
