...
JNIEXPORT jint JNICALL Java_com_pyrus_audiocontroller_opus_OpusDecoder_nativeInitDecoder (JNIEnv *env, jobject obj, jint samplingRate, jint numberOfChannels)
{
	int size;
	int error;
...
JNIEXPORT jint JNICALL Java_com_pyrus_audiocontroller_opus_OpusDecoder_nativeDecodeShorts (JNIEnv *env, jobject obj, jbyteArray in, jshortArray out, jint frames)
{
    jclass cls = (*env)->GetObjectClass(env, obj);
    jfieldID fid = (*env)->GetFieldID(env, cls, "address", "J");
...
JNIEXPORT jint JNICALL Java_com_pyrus_audiocontroller_opus_OpusDecoder_nativeDecodeBytes (JNIEnv *env, jobject obj, jbyteArray in, jbyteArray out, jint frames)
{
    jclass cls = (*env)->GetObjectClass(env, obj);
    jfieldID fid = (*env)->GetFieldID(env, cls, "address", "J");
    OpusDecoder* dec = (OpusDecoder*)((*env)->GetLongField(env, obj, fid));
...
JNIEXPORT jboolean JNICALL Java_com_pyrus_audiocontroller_opus_OpusDecoder_nativeReleaseDecoder (JNIEnv *env, jobject obj)
{
    jclass cls = (*env)->GetObjectClass(env, obj);
    jfieldID fid = (*env)->GetFieldID(env, cls, "address", "J");
